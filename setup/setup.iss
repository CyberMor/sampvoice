...
[Files]
Source: "files_permanent\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs uninsneveruninstall
Source: "files_temporary\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
